...
import {
  FerramentasCreateComponent
} from "./components/views/ferramentas/ferramentas-crud/ferramentas-create/ferramentas-create.component";
...
const routes: Routes = [
  ...
  { path: 'ferramentasCreate', component: FerramentasCreateComponent},
